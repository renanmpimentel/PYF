...
?>
	...
	<form id="form" name='form' action="<?php echo WEB_ROOT_APP ?>/Cliente/salvar" method="POST">  	  
	  ...
	  <fieldset>
		...
		<div class="row pull-right">
			<div class="form-group col-lg-12 col-sm-12">
		    	...
		    	<a href="<?php echo WEB_ROOT_APP ?>/Cliente/listar" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
			</div>
		</div>
